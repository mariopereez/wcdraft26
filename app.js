...
function switchResTab(tab, btn) {
  ...
  const resPredsWrap = document.getElementById('res-predicciones-wrap'); if(resPredsWrap) resPredsWrap.style.display = tab==='predicciones'?'block':'none';
  if(tab==='todos') renderTodosMatches();
  else if(tab==='predicciones') renderPrediccionesTab();
}
...
function renderResults() {
  ...
  if(resTabActive==='predicciones'){renderPrediccionesTab();return;}
  ...
  const resPredsWrap = document.getElementById('res-predicciones-wrap'); if(resPredsWrap) resPredsWrap.style.display='none';
