      ...
      <div class="admin-group-matches">
        ${gMatches.map((m, i) => {
          ...
          return `<div class="admin-match-row">
            <div class="admin-match-team">${flagImg(m.home)} <span>${m.home}</span></div>
            ...
            <div class="admin-match-team away">${flagImg(m.away)} <span>${m.away}</span></div>
      ...
      ${rMatches.slice(0, count).map((m, i) => {
        ...
        return `<div class="admin-match-row admin-ko-row">
          <select class="admin-team-select" id="admin-k-${key}-${i}-home">
            ...
            ${ALL_TEAMS.map(t => `<option value="${t}" ${m.home === t ? 'selected' : ''}>${t}</option>`).join('')}
          </select>
          <div class="admin-match-score">
          ...
          <select class="admin-team-select" id="admin-k-${key}-${i}-away">
            ...
            ${ALL_TEAMS.map(t => `<option value="${t}" ${m.away === t ? 'selected' : ''}>${t}</option>`).join('')}
          </select>
